...
![example workflow](https://github.com/aravindc26/go-mysql/actions/workflows/ci.yml/badge.svg)
...
```
replace github.com/siddontang/go-mysql => github.com/aravindc26/go-mysql v1.7.0
```
